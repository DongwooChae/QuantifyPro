...
# 5) 첨부파일 리스트
attachments = [r"\\10.10.10.11\Ai본부\F.AI본부\@대체평가2사업본부\메일 발송 자동화 프로그램\첨부파일\산은캐피탈_펀드요청자료목록_20250331(사전요청).xlsx"]
# attachments = [r"C:\Users\dwchae23\Desktop\일정관리\의뢰리스트 확정 및 자료요청 일괄 전송메일\25.2Q\산은캐피탈_펀드요청자료목록_20250331(사전요청).xlsx"]

# 6) 평가자 연락처 파일 경로
person_path = r"\\10.10.10.11\Ai본부\F.AI본부\@대체평가2사업본부\메일 발송 자동화 프로그램\backdata\평가자연락처.xlsx"
